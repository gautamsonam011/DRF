...
from .views import create_views_data, get_all_data, update_record, vehicle_details_op, postProfile, Call_view, SendOTPView, VerifyOTPView, ItemList, google_map_view, my_google_map_view, weather_api_view
...
urlpatterns = [
    ...
    path('vehicle-name/', Call_view.as_view(), name="vehicle-name"),
