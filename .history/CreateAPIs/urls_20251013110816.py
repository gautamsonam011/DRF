...
from .views import create_views_data, get_all_data, update_record, vehicle_details_op, postProfile, SendOTPView, VerifyOTPView, ItemList, google_map_view, my_google_map_view, weather_api_view
