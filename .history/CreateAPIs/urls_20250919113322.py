...
from .views import create_views_data, get_all_data, update_record, vehicle_details_op, SendOTPView, VerifyOTPView
...
urlpatterns = [
    ...
    path('verofy_otp/', VerifyOTPView.as_view(), name = 'verify-otp'),
